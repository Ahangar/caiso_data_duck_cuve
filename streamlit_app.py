...
These challenges can be mitigated through by accurate solar generation forecasting, increased energy storage capacity, or enhanced system flexibility and demand response programs [4]
...
st.markdown("""
With rising solar and wind generation, the duck curve has become increasingly pronounced. Here, I visualize these changes in California using data from CAISO. Notice how the net-load curve drops lower during midday each month as more solar capacity is added to the grid. During the spring months, the average net demand curve is negative during the 2025.
""", unsafe_allow_html=True)
